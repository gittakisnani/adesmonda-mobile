...
const MyAddress = ({ style = null, includeTrash = true, includeChange = true }) => {
  return (
    <div style={style || { background: 'rgba(255, 255, 255, 0.01)'}} className='p-2 pr-4 flex flex-col gap-3 border border-[#D9D9D9] rounded-xl'>
        <div  className='flex justify-between items-center '>
            <div className='flex items-center gap-2'>
                ...
                <p className='tracking-[1px] font-bold text-sm'>Mas DW</p>
            </div>
            {includeTrash && <button>
        ...
        <p className='leading-6 tracking-[1px] text-[#121212] text-xs'>Jl Brigjen H Kassim Lr Santoso No 1307 X Kalidoni, Kec. Kalidoni, Kota Palembang, Sumatera Selatan</p>
