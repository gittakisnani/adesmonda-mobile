...
const MyCart = ({ id, checked, handleChecked }) => {
  ...
  return (
    <div style={{ background: 'rgba(0, 68, 65, 0.05)'}} className='rounded-sm p-2 flex items-center gap-4'>
        ...
        <div className='flex flex-col flex-1 overflow-hidden gap-3'>
            ...
            <p className='text-xs text-[#9CB6B5] mt-[-1]'>Black</p>
            <div className='flex justify-between items-center'>
                <p style={{ fontFamily: 'Plus Jakarta Sans'}} className='text-sm font-bold leading-4 tracking-[1.5px] text-primary'>Rp 123.456.789</p>
