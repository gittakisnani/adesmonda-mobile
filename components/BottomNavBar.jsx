...
const BottomNavbar = () => {
  ...
  return (
    <nav style={{boxShadow: '0px -2px 10px rgba(0, 68, 65, 0.1), inset 0px 2px 5px #FFFFFF'}} className='flex items-start justify-between sm:justify-center gap-2 bg-[#F9F9F9] rounded-t-xl h-[65px] px-1 pb-3 sticky bottom-0'>
